...
internal class FavouriteShowRemoteViewsFactory (private val context: Context) : RemoteViewsService.RemoteViewsFactory {
    ...
    override fun onDataSetChanged() {
        ...
        mWidgetItems = MappingHelper.mapCursorToArrayListShow(cursor)
    ...
    override fun getViewAt(position: Int): RemoteViews {
        ...
        val extras = bundleOf(
            FavouriteShowWidget.EXTRA_ITEM to mWidgetItems[position].title
        )
